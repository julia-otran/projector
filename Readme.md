...
2. virtualScreenId: id da tela virtual:
  ...
  - main: Tela principal
  - chroma: Tela com fundo verde
  - main-chroma: Usar quando há apenas uma tela principal e esta é uma tela `chroma`
...
5. `x` e `y`: Posição da tela virtual que deve ser exibida nessa tela.
  ...
  +----------------+----------------+
  ```
  Você deve usar `x = 0; y = 0` no projetor 1; e `x = 1280; y = 0` no projetor 2.
...
7. `helpLines`: Você pode criar linhas para auxiliar no alinhamento dos projetores.
  - Descobrindo o tamanho da área de blending:
  ...
  - Alinhando keystone com múltiplos projetores:
    1. No projetor #1 crie uma linha à direita `x1 = 1280, x2 = 1280, y1 = 0, y2 = 720`
    ...
    5. Alinhe os projetores de forma que as 4 linhas pareçam 2, ou seja a linha do passo 1 coincidindo com a do passo 4 e a linha do passo 2 coincidindo com a linha do passo 3

  *Dica: crie linhas em cima, em baixo, à esquerda, à direita. Com isso, alinhe o keystone do projetor com a tela*
