...
static int glad_gl_get_extensions(GladGLES1Context *context, int version, const char **out_exts, unsigned int *out_num_exts_i, char ***out_exts_i) {
...
static int glad_gl_find_extensions_gles1(GladGLES1Context *context, int version) {
