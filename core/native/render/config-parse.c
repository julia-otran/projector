...
void parse_config_color_corrector_single(cJSON* config_color_corrector_json, config_color_corrector* out) {
    ...
    cJSON* src_lum_json = cJSON_GetObjectItemCaseSensitive(config_color_corrector_json, "src_lum");
    ...
    if (cJSON_IsNumber(src_lum_json)) {
        out->src_lum = src_lum_json->valuedouble;
    }
